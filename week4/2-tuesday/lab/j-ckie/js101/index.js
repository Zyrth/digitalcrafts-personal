Number.isInteger = Number.isInteger || function(value) {
  ...
  function testDeclareArray (element) {
    try {
      ...
      if (!(_.isArray(result) && result.length === 2 && result[0] === 'Hello World!' && result[1] === 4)) {
        throw false
      }
      showSuccess(element)
    } catch (err) {
  ...
  function testDeclareObject (element) {
    try {
      ...
      if (!(_.isPlainObject(result) && result.key1 === 'Hello World!' && result.key2 === 4)) {
        throw false
      }
      showSuccess(element)
    } catch (err) {
  ...
  function testOr (element) {
    try {
      ...
      if ((result1 !== true) || (result2 !== true) || (result3 !== true) || (result4 !== false)) {
        throw false
      }
      showSuccess(element)
    } catch (err) {
  ...
  function testEquivalence (element) {
    try {
      ...
      if ((result1 !== true) || (result2 !== false) || (result3 !== false) || (result4 !== true)) {
        throw false
      }
      showSuccess(element)
    } catch (err) {
